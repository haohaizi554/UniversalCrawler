...
REQUIRED_INSTALL_SOURCE_ENTRIES = (
    ...
    lambda: DIST_DIR / "_internal" / "app" / "web" / "static" / "toolbox.css",
    ...
    lambda: DIST_DIR / "_internal" / "app" / "web" / "static" / "toolbox_contract.js",
    lambda: DIST_DIR / "_internal" / "app" / "web" / "static" / "toolbox_view.js",
    lambda: DIST_DIR / "_internal" / "app" / "web" / "static" / "toolbox_controller.js",
