...
def _bootstrap_registry() -> None:
    ...
    register_category_rule(
        ...
        include=[
            ...
            "tests/test_ui_*.py",
            "tests/test_unified_frontend*_contract.py",
            "tests/test_log_*.py",
    ...
    register_category_rule(
        ...
        include=[
            ...
            "tests/test_xiaohongshu_*.py",
            "tests/test_bilibili_*.py",
            "tests/test_path_*.py",
            "tests/test_core_*.py",
    ...
    register_category_rule(
        ...
        include=[
            ...
            "tests/test_large_frontend_file_boundaries.py",
        ],
        icon_color="#0F766E",
        icon_letter="ARCH",
        priority=85,
