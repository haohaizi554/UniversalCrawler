...
class BaseSpiderTests(unittest.TestCase):
    ...
    def test_stop_defers_tracked_playwright_close_to_owner_thread(self):
        spider = _DummySpider(keyword="demo", config={})
        ...
        self.assertTrue(spider.is_playwright_browser_tracked())
        self.assertFalse(spider.is_running)

        spider._close_tracked_playwright_browser()
