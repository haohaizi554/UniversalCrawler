...
from tests.support.browser_cases.dialogs_and_keyboard import DialogsAndKeyboardCases as _DialogsAndKeyboardCases
from tests.support.browser_cases.frontend_runtime import FrontendRuntimeCases as _FrontendRuntimeCases
from tests.support.browser_cases.frontend_runtime_state import FrontendRuntimeStateCases as _FrontendRuntimeStateCases
from tests.support.browser_cases.localization_and_logs import LocalizationCases as _LocalizationCases
from tests.support.browser_cases.log_center import LogCenterCases as _LogCenterCases
from tests.support.browser_cases.log_center_workers import LogCenterWorkerCases as _LogCenterWorkerCases
from tests.support.browser_cases.log_semantics import LogSemanticsCases as _LogSemanticsCases
from tests.support.browser_cases.network_guard import NetworkGuardCases as _NetworkGuardCases
from tests.support.browser_cases.playback import PlaybackCases as _PlaybackCases
from tests.support.browser_cases.responsive_layout import ResponsiveLayoutCases as _ResponsiveLayoutCases
from tests.support.browser_cases.runtime_and_lists import RuntimeAndListCases as _RuntimeAndListCases
from tests.support.browser_cases.settings import SettingsCases as _SettingsCases
from tests.support.browser_cases.smoke_and_assets import SmokeAndAssetsCases as _SmokeAndAssetsCases
from tests.support.browser_runtime import (
...
class StaticAssetsTests(unittest.TestCase):
    ...
    def test_index_html_exists(self):
        p = PROJECT_ROOT / "app" / "web" / "static" / "index.html"
    ...
    def test_index_html_uses_webui_favicon(self):
        index = (PROJECT_ROOT / "app" / "web" / "static" / "index.html").read_text(
            encoding="utf-8"
        )
    ...
    def test_completed_preview_controls_are_visible_not_compat_hidden(self):
        html_path = PROJECT_ROOT / "app" / "web" / "static" / "index.html"
    ...
    def test_static_assets_are_cache_busted(self):
        ...
        self.assertIn('/static/app.js?v=20260716-completed-delete', content)
    ...
    def test_split_frontend_scripts_share_cache_version_and_load_order(self):
        ...
        self.assertEqual({version for _name, version in split_scripts}, {"20260716-completed-delete"})
    ...
    def test_platform_settings_static_contract_matches_gui(self):
        content = _static_bundle_content()
        platform_limits = (
            PROJECT_ROOT / "app" / "web" / "static" / "platform_limits.js"
    ...
    def test_frontend_delta_uses_batched_section_rendering(self):
        runtime = (PROJECT_ROOT / "app" / "web" / "static" / "frontend_runtime.js").read_text(encoding="utf-8")
    ...
    def test_interaction_map_does_not_keep_stale_fixed_bug_claims(self):
        doc = (PROJECT_ROOT / "app" / "web" / "INTERACTION_MAP.md").read_text(encoding="utf-8")
        stale_claims = [
    ...
    def test_web_log_display_limit_is_applied_to_local_state(self):
        content = _static_bundle_content()
        app = (PROJECT_ROOT / "app" / "web" / "static" / "app.js").read_text(encoding="utf-8")
