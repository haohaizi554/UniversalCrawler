...
def build_web_app_composition(
    *,
    ...
    session_registry = WebSessionRegistry(
        send_factory=lambda session_id: lambda event_type, data=None: manager.emit_to_session(session_id, event_type, data),
    ...
    ws_session_binder = WebSocketSessionBinder(session_registry, default_session_id=default_session_id)
