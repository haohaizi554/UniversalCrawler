...
class StatusBarWidget(QFrame):
    ...
    def __init__(self, *, is_dark: bool = False) -> None:
        ...
        self.lbl_download = self._metric_label(metrics, "下载速度")
        self.lbl_completed = self._metric_label(metrics, "已完成")
        self.lbl_failed = self._metric_label(metrics, "失败")
        ...
        self.lbl_version = QLabel("v2.31.108")
    ...
    def _metric_label(self, parent_layout: QHBoxLayout, title: str) -> QLabel:
        row = QHBoxLayout()
        row.setSpacing(6)
    ...
    def render(self, status: dict) -> None:
        ...
        running_state = str(merged.get("running_state") or "空闲中")
        ...
        self.lbl_version.setText(str(merged.get("version") or "v1.0.0"))
