...
> 开发向的分层说明见 [docs/architecture.md](docs/architecture.md)；图示索引见 [mermaid/README.md](mermaid/README.md)。
...
| [docs/](docs/) + [mermaid/](mermaid/) | 开发、测试、打包、API 等专题文档与图示 |
...
CLI / 交互式 / 自适应调度仅适用于源码环境或 pip 安装后的 console scripts。`BUILD_INFO.txt` 与 [docs/packaging.md](docs/packaging.md) 已按此模型描述。
...
### 6.6 测试职责边界（与 docs/architecture.md 一致）
...
- 事故复盘：[docs/postmortems/](docs/postmortems/)
...
1. **分层清晰** — entry / shared / app / cli 边界明确，平台接入有文档化最小路径（[docs/development.md](docs/development.md)）。
...
- **高风险区域**（[docs/architecture.md](docs/architecture.md)）：浏览器事件监听、扩展名修正、多阶段用户选择、登录降级路径。
...
| 文档 | 内容 |
|------|------|
| [docs/architecture.md](docs/architecture.md) | 分层职责、数据流、测试边界 |
| [docs/development.md](docs/development.md) | 新代码放置、平台接入最小路径 |
| [docs/api.md](docs/api.md) | 内部接口说明 |
| [docs/config.md](docs/config.md) | config.json 字段参考 |

### 测试与质量

| 文档 | 内容 |
|------|------|
| [docs/testing.md](docs/testing.md) | 测试策略、注册表、启动器 |
...
| 文档 | 内容 |
|------|------|
| [docs/packaging.md](docs/packaging.md) | 发布流程、验收清单 |
| [packaging/README.md](packaging/README.md) | 打包目录职责 |
| [docs/containerization.md](docs/containerization.md) | Docker 部署 |
| [docs/windows-file-association.md](docs/windows-file-association.md) | 文件关联 |

### CLI / SDK

| 文档 | 内容 |
|------|------|
| [docs/cli/CLI_GUIDE.md](docs/cli/CLI_GUIDE.md) | 命令行指南 |
| [docs/cli/SDK_GUIDE.md](docs/cli/SDK_GUIDE.md) | SDK 编程接口 |
| [docs/cli/API_REFERENCE.md](docs/cli/API_REFERENCE.md) | REST API 参考 |
| [docs/SKILL_GUIDE.md](docs/SKILL_GUIDE.md) | AI Skill 集成 |
...
*本文档随仓库架构演进更新；结构调整时请同步修订本节与 [docs/architecture.md](docs/architecture.md)。*
