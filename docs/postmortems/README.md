...
| [signed-update-manifest-and-package-size.md](signed-update-manifest-and-package-size.md) | 热更新签名资产漏传、Playwright 历史缓存膨胀、安装包超限与日志入口断链复盘 |

复盘文档只记录已经踩过坑、根因和后续守则；普通修复记录放在 `docs/fixes/`。

如果某个复盘已经沉淀为长期规则，优先阅读 `docs/engineering/` 中的对应工程实践文档。
