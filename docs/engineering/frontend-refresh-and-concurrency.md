...
- 2026-07-09 全量 `python -m pytest -q`：`2220 passed, 3 skipped, 7 warnings in 134.72s (0:02:14)`。
- 近期连续基线为 `2141 -> 2145 -> 2149 -> 2151 -> 2154 -> 2188 -> 2220`；耗时从 `208s -> 190s -> 117s -> 187s -> 237s -> 181s -> 135s` 波动，当前实测约 2 分 14 秒。后续比较优化收益时优先记录精确秒数，不再只写“3 到 4 分钟”。
