...
- 2026-07-09 全量 `python -m pytest -q`：`2227 passed, 3 skipped, 7 warnings in 191.54s (0:03:11)`。
- 近期连续基线为 `2141 -> 2145 -> 2149 -> 2151 -> 2154 -> 2188 -> 2220 -> 2225 -> 2227`；耗时从 `208s -> 190s -> 117s -> 187s -> 237s -> 181s -> 135s -> 194s -> 192s` 波动，当前实测约 3 分 11 秒。后续比较优化收益时优先记录精确秒数，不再只写“3 到 4 分钟”。
