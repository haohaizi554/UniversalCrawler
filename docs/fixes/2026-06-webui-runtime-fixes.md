...
- `tests/contract/web/test_fastapi_endpoints.py::StateEndpointTests::test_frontend_delta_endpoint_matches_rest_router_contract`
- `tests/e2e/web/test_browser_journeys.py::StaticAssetsTests::test_static_assets_are_cache_busted`
- 全量 `pytest -q`
