...
| 文档 | 内容 |
| --- | --- |
| [architecture.md](architecture.md) | 当前工程架构、前端适配层、worker 刷新链路和主题 shell 边界 |
| [api.md](api.md) | 前端状态服务、Web REST 直连/组合路由和 WebSocket 约定 |
| [development.md](development.md) | 本地开发流程、局部验证命令和文档维护口径 |
...
| [ai-skill-guide.md](ai-skill-guide.md) | AI 辅助开发技能说明 |
