...
1. **分层清晰** — entry / shared / app / cli 边界明确，平台接入有文档化最小路径（[docs/development.md](../guides/development.md)）。
...
| [docs/development.md](../guides/development.md) | 新代码放置、平台接入最小路径 |
| [docs/api.md](../guides/api.md) | 内部接口说明 |
...
| [docs/containerization.md](../guides/containerization.md) | Docker 部署 |
| [docs/windows-file-association.md](../guides/windows-file-association.md) | 文件关联 |

### CLI / SDK

| 文档 | 内容 |
|------|------|
| [docs/cli/CLI_GUIDE.md](../cli/CLI_GUIDE.md) | 命令行指南 |
| [docs/cli/SDK_GUIDE.md](../cli/SDK_GUIDE.md) | SDK 编程接口 |
| [docs/cli/API_REFERENCE.md](../cli/API_REFERENCE.md) | REST API 参考 |
