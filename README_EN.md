...
<p align="left">
  ...
  <img alt="Version" src="https://img.shields.io/badge/Version-v3.6.18-7C3AED" />
...
The current source repository directory is `UniversalCrawlerProplus/`. The Python package and CLI entry name is `ucrawl`, while desktop distribution continues to expose `UniversalCrawlerPro.exe` and `CrawlerWebPortal.exe` as the two packaged entry points. The current project version is **v3.6.18**.
